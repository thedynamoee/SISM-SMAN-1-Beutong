  	...
  	<div class="col-md-12">
  		<div class="navbar-header">
  			<ul class="nav navbar-nav navbar-center">
  				<li><a href="javascript:void(0)"><span class='glyphicon glyphicon-send' aria-hidden='true'></span>&nbsp;<b> Sistem Informasi Surat Menyurat SMAN 1 Beutong Aceh</b></a></li>
  			</ul>
  		</div>
  	</div>
  </nav>
  	...
  	<div class="kotak">
  		...
  		<div class="wrapper">
  			<p style="padding: 20px 10px; text-align-last: center;">
  				<img src="<?php echo base_url('foto/defaultt.jpg') ?>" height="100">
  			</p>
