...
<body onload="window.print()">
    <table>
        <tr>
            ...
            <td>
                <p class="kop" style="margin-top: 10px;"><?php echo $skl->kop_1; ?></p>
                <p class="kop"><?php echo $skl->kop_2; ?></p>
                <p class="kop"><?php echo $skl->sekolah; ?></p>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="isi">: <?php echo $sql->no_sm; ?></td>
        ...
        <tr>
            ...
            <td class="isi" colspan="3">: <?php echo $skl->jabatan; ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="isi">Petunjuk</td>
            <td class="isi" colspan="3">: <?php echo $sql->biasa; ?></td>
        </tr>
        <tr>
