                ...
                ?>
                  <tr>
                    <td class="text-center">
                      <?php
                      if ($baris->dibaca == 3) { ?>
                        <span class="badge badge-success"><i class="icon-checkmark4"></i> <?php echo $baris->no_sm; ?></span>
                      <?php } elseif ($baris->dibaca == 2) { ?>
                        <span class="badge badge-primary"><i class="icon-bell3"></i> <?php echo $baris->no_sm; ?></span>
                      <?php } elseif ($baris->dibaca == 1) { ?>
                        <span class="badge badge-warning"><i class="icon-spinner"></i> <?php echo $baris->no_sm; ?></span>
                      <?php } else { ?>
                        <span class="badge badge-danger"><i class="icon-cancel-circle2"></i> <?php echo $baris->no_sm; ?></span>
                      <?php } ?>
                    </td>
