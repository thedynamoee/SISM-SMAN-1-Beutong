                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <div class="input-group">
                      ...
                      <input type="text" name="no_asal" id="no_asal" class="form-control" value="<?php echo $query->no_sm; ?>" placeholder="" required readonly>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-12 col-sm-12" style="overflow-x:auto;">
                    <table class="table table-xs table-responsive table-striped table-bordered" style="width: 100%;">
                      ...
                      foreach ($lampiran->result() as $baris) { ?>
                        <tr>
                          <td><?php echo $query->no_sm; ?></td>
                          <td><?php echo $baris->nama_berkas; ?></td>
                          <td><?php echo $query->tgl_sm; ?></td>
                          <td><?php echo substr($baris->ukuran / 1024, 0, 5); ?> MB</td>
                          <td class="text-center">
                            <a href="lampiran/surat_masuk/<?php echo $baris->nama_berkas; ?>" target="_blank" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-eye-open"></span><b>&nbsp; Preview File</b></a>
                          </td>
                          </td>
                        </tr>
                      <?php
