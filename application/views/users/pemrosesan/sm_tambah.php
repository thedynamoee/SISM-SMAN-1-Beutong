          ...
          <div class="panel-heading text-left">
            <div class="row">
              <div class="col-sm-6 text-left">
                <span class="glyphicon glyphicon-home" aria-hidden="true"></span><b>&nbsp; TAMBAH SURAT MASUK</b><br><?php echo $skl->sekolah; ?>
              </div>
            </div>
          </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <div class="input-group">
                      ...
                      <!-- <input type="text" name="nsx" id="nsx" class="form-control" placeholder="" value="<?php echo $no_sm; ?>" required readonly> -->
