...
<body onload="window.print()">
    <table>
        <tr>
            ...
            <td align="left">
                <p class="name-school1"><?php echo $skl->kop_1; ?></p>
                <p class="name-school"><?php echo $skl->kop_2; ?></p>
                <p class="name-school"><?php echo $skl->sekolah; ?></p>
                <p class="alamat_1"><?php echo $skl->alamat; ?></p><br>
                <p class="alamat_1"><?php echo $skl->telp; ?></p><br><br>
            </td>
        </tr>
    </table>
    <hr class="hr_satu">
    ...
    <table border="0">
        ...
        <tr>
            ...
            <td class="isi">: <?php echo $skl->nm_kepala; ?></td>
        </tr>
        <tr>
            <td class="isi">NIP</td>
            <td class="isi">: <?php echo $skl->nip; ?></td>
        </tr>
        <tr>
            <td class="isi">Jabatan</td>
            <td class="isi">: <?php echo $skl->jabatan; ?></td>
        </tr>
        <tr>
            <td class="isi">Sekolah</td>
            <td class="isi">: <?php echo $skl->sekolah; ?></td>
        </tr>
        <tr>
            <td class="isi">NPSN </td>
            <td class="isi">: <?php echo $skl->npsn; ?></td>
        </tr>
        <tr>
            <td class="isi">Alamat</td>
            <td class="isi">: <?php echo $skl->alamat; ?></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td class="isi">NIS / NISN</td>
            <td class="isi">: <?php echo $sql->nis ?> / <?php echo $sql->nisn ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" class="isi_paragraf">
                Yang bersangkutan benar-benar Peserta Didik <?php echo $skl->sekolah; ?> Tahun Pelajaran <?php echo $skl->tapel; ?>.
        ...
        <table>
            <tr>
                ...
                <td width="50%">
                    ...
                    <p class="ttd-kanan" style="margin-top: -15px;"><?php echo $skl->jabatan; ?></p>
                    <br><br><br><br>
                    <p class="ttd-kanan"><?php echo $skl->nm_kepala; ?></p>
                </td>
            </tr>
        </table>
    <?php } elseif ($sql->ttd == '2') { ?>
        <table>
            <tr>
                ...
                <td width="50%">
                    <p class="ttd-kanan"><?php echo $sql->tgl_ska; ?></p>
                    <p class="ttd-kanan" style="margin-top: -15px;">Kepala Sekolah</p>
                    <br>
                    <p class="ttd-kanan">^</p>
                    <br>
                    <p class="ttd-kanan"><?php echo $skl->nm_kepala; ?></p>
