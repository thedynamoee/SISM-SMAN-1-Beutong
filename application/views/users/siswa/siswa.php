                    ...
                    <div class="panel-heading text-left">
                        <div class="row">
                            <div class="col-sm-6 text-left">
                                <span class="glyphicon glyphicon-home" aria-hidden="true"></span><b class="">&nbsp; DAFTAR SISWA</b><br>
                            </div>
                            <div class="col-md-6 text-right">
                                <?php
                                if ($user->row()->level <> 's_admin') { ?>
                                    <a href="users/siswa/t" class="btn btn-xs btn-success" style="margin-top: 5px;"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span><b>&nbsp; TAMBAH DATA SISWA</b></a>
                                <?php
                                } ?>
                            </div>
                        </div>
