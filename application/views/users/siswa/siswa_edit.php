                    ...
                    <div class="panel-heading text-left">
                        <div class="row">
                            <div class="col-sm-6 text-left">
                                <span class="glyphicon glyphicon-home" aria-hidden="true"></span><b>&nbsp; EDIT SISWA</b><br>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="nis" id="nis" value="<?php echo $query->nis; ?>" class="form-control" placeholder="Masukkan Nomor Induk Sekolah (NIS)" required>
                                        </div>
                                    </div>
