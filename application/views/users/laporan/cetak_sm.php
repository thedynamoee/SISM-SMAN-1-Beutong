  ...
  <table width="100%">
    <tr>
      ...
      <td align="left">
        ...
        <p class="alamat"><b><?php echo $skl->alamat; ?></b></p>
        <p class="alamat2"><?php echo $skl->telp; ?></p>
      </td>
    </tr>
  </table>
  <hr>
  ...
  <table>
    <tr>
      <td width="50%">
        ...
        <p class="ttd-kiri"><?php echo $skl->jabatan; ?></p>
        <br><br><br>
        <p class="ttd-kiri"><b><?php echo $skl->nm_kepala; ?></b></p>
      </td>
      <td width="50%">
